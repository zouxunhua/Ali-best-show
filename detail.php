...
where posts.id = $id;";
  ...
  $oldView++;
  // 修改阅读数
  my_ZSG("update posts set views =$oldView where id = $id");
    ...
    <div class="content">
      <div class="article">
        <div class="breadcrumb">
          <dl>
            <dt>当前位置：</dt>
            <dd><a href="javascript:;"><?php echo $data[0]; ?></a></dd>
            <dd><?php echo $data[1]; ?></dd>
          </dl>
        </div>
        <h2 class="title">
          <a href="javascript:;"><?php echo $data[1]; ?></a>
        </h2>
        <div class="meta">
          <span><?php echo $data[2]; ?> 发布于 <?php echo $data[3]; ?></span>
          <span>分类: <a href="javascript:;"><?php echo $data[0]; ?></a></span>
          <span>阅读: (<?php echo $data[5]; ?>)</span>
          <span>评论: (143)</span>
        </div>
        <?php echo $data[4]; ?>
      </div>
